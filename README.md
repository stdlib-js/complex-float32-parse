...
```javascript
import parseComplex64 from 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-float32-parse@v0.0.1-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/complex-float32-parse/actions/workflows/test.yml/badge.svg?branch=v0.0.1
[test-url]: https://github.com/stdlib-js/complex-float32-parse/actions/workflows/test.yml?query=branch:v0.0.1
